...
Normative rules for traits and generics in Logos, mechanically extracted from the compiler (grammar, sema, mono, codegen layers). Each `### id` is a permanent linkable address; ids are preserved verbatim and never merged or renamed.
...
**Source:** `src/compiler/sema_impl.hpp#L2644`
...
**Source:** `src/compiler/sema_impl.hpp#L3186-L3191`
...
**Source:** `src/compiler/sema_impl.hpp#L2598-L2599`
...
**Source:** `src/compiler/sema_impl.hpp#L2600-L2613`
...
> Note: this id is documented by 2 extracted rule artifacts from different source layers. Both are surfaced below; they are complementary (same rule, different code sites), not conflicting.

**Variant 1 — Sized bound is a no-op** _(source: `sema/sema_collect/simplify_all_types.json`)_
...
**Source:** `src/compiler/sema_collect.cpp#L879-L883`

**Variant 2 — `Sized` is a builtin no-op bound** _(source: `sema/sema_impl_hpp/logos.part3.json`)_
...
**Source:** `src/compiler/sema_impl.hpp#L1623-L1628`
...
**Source:** `src/compiler/sema_impl.hpp#L3617-L3629`
...
**Variant 1 — Auto traits are satisfied structurally** _(source: `sema/sema_auto_trait/logos.json`)_
...
**Variant 2 — Auto-trait satisfaction synthesized structurally** _(source: `sema/sema_collect/simplify_all_types.json`)_
...
**Source:** `src/compiler/sema_impl.hpp#L2051-L2054`, `src/compiler/sema_impl.hpp#L1930-L1930`
...
**Variant 1 — blanket impl detection** _(source: `sema/sema_collect/collect_type_alias.part2.json`)_
...
**Variant 2 — An impl whose target is one of its own type parameters is a blanket impl** _(source: `sema/sema_decl/lower_struct_def.part2.json`)_
...
**Source:** `src/compiler/sema_impl.hpp#L2950-L2963`, `src/compiler/sema_impl.hpp#L2990-L2993`
...
**Source:** `src/compiler/sema_impl.hpp#L2663`
...
**Source:** `src/compiler/sema_impl.hpp#L3885-L3897`
...
**Source:** `src/compiler/sema_impl.hpp#L3579-L3596`
...
## Operator/method overload resolution
...
**Source:** `src/compiler/sema_impl.hpp#L3773-L3789`
...
**Source:** `src/compiler/mlir_gen_impl.hpp#L228-L274`
...
**Source:** `src/compiler/sema_impl.hpp#L2856-L2862`
...
**Source:** `src/compiler/mlir_gen_impl.hpp#L415-L421`
...
**Source:** `src/compiler/mlir_gen_impl.hpp#L429-L432`
...
**Source:** `src/compiler/mlir_gen_impl.hpp#L422-L427`
...
**Source:** `src/compiler/mlir_gen_impl.hpp#L429-L436`
...
**Source:** `src/compiler/mlir_gen_impl.hpp#L401-L414`
...
**Variant 1 — Tag-based dispatch keys on a runtime type-code read from the receiver** _(source: `codegen/mlir_gen_dyn/gen_tagged_dispatch.json`)_
...
**Variant 2 — Tagged dynamic dispatch is keyed by per-type type_code** _(source: `codegen/mlir_gen_dyn/logos.json`)_
...
**Source:** `src/compiler/sema_impl.hpp#L3258-L3266`
...
**Source:** `src/compiler/sema_impl.hpp#L4282-L4300`
...
**Source:** `src/compiler/sema_impl.hpp#L2618-L2624`
...
**Source:** `src/compiler/sema_impl.hpp#L2625-L2633`
...
**Source:** `src/compiler/sema_impl.hpp#L3248-L3256`, `src/compiler/sema_impl.hpp#L3310-L3316`
...
**Source:** `src/compiler/sema_impl.hpp#L2996-L3001`
...
**Source:** `src/compiler/sema_impl.hpp#L3268-L3331`
...
**Source:** `src/compiler/sema_impl.hpp#L3297-L3304`
