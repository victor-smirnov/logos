...
*Source:* `tools/peg_gen/grammars/logos.peg#L2966-L2967`
...
*Source:* `tools/peg_gen/grammars/logos.peg#L2970-L2973`
...
*Source:* `tools/peg_gen/grammars/logos.peg#L3187-L3189`
...
*Source:* `tools/peg_gen/grammars/logos.peg#L3204-L3213`
...
*Source:* `tools/peg_gen/grammars/logos.peg#L3220-L3225`
...
*Source:* `tools/peg_gen/grammars/logos.peg#L3226-L3229`
...
*Source:* `tools/peg_gen/grammars/logos.peg#L3073-L3075`
...
*Source:* `tools/peg_gen/grammars/logos.peg#L3141-L3145`
...
*Source:* `tools/peg_gen/grammars/logos.peg#L3174-L3177`
...
*Note:* Documented as 'Phase 1' restriction; enforcement occurs outside this slot-table unit.

*Source:* `tools/peg_gen/grammars/logos.peg#L75`
...
*Source:* `tools/peg_gen/grammars/logos.peg#L3092-L3096`
...
*Source:* `tools/peg_gen/grammars/logos.peg#L3095-L3124`
...
*Note:* Production and the sema-side check `ident == "from"` live in grammar/logos/rule-module; this unit only documents the contextual-keyword status.
...
*Note:* PEG-tooling directive (grammar-composition surface), not a Logos-source language rule; included as the observable export contract of the Writ literal sub-grammar.

*Source:* `tools/peg_gen/grammars/writ.peg#L17-L17`
...
*Source:* `tools/peg_gen/grammars/writ.peg#L31-L43`
...
*Source:* `tools/peg_gen/grammars/writ.peg#L39`
...
*Source:* `tools/peg_gen/grammars/writ.peg#L40`
...
*Source:* `tools/peg_gen/grammars/writ.peg#L81-L91`
...
*Source:* `tools/peg_gen/grammars/writ.peg#L104-L106`
...
*Source:* `tools/peg_gen/grammars/writ.peg#L114-L119`
...
*Source:* `tools/peg_gen/grammars/writ.peg#L121-L125`
...
*Source:* `tools/peg_gen/grammars/hrpc.peg#L100-L101`
...
*Source:* `tools/peg_gen/grammars/hrpc.peg#L104-L105`, `tools/peg_gen/grammars/hrpc.peg#L100`

### `grammar.hrpc.import-decl` — Import declaration

import_def := 'import' STRING ';' — import path is a string literal.

*Source:* `tools/peg_gen/grammars/hrpc.peg#L108-L109`
...
*Source:* `tools/peg_gen/grammars/hrpc.peg#L112-L115`, `tools/peg_gen/grammars/hrpc.peg#L118`, `tools/peg_gen/grammars/hrpc.peg#L124`
...
*Source:* `tools/peg_gen/grammars/hrpc.peg#L118`
...
*Source:* `tools/peg_gen/grammars/hrpc.peg#L121-L124`
...
*Source:* `tools/peg_gen/grammars/hrpc.peg#L127-L130`
...
*Source:* `tools/peg_gen/grammars/hrpc.peg#L133-L137`
...
*Source:* `tools/peg_gen/grammars/hrpc.peg#L140-L144`
...
*Source:* `tools/peg_gen/grammars/hrpc.peg#L147-L148`
...
*Source:* `tools/peg_gen/grammars/hrpc.peg#L150-L151`
...
*Source:* `tools/peg_gen/grammars/hrpc.peg#L154-L156`
...
*Source:* `tools/peg_gen/grammars/hrpc.peg#L160-L162`
...
*Source:* `tools/peg_gen/grammars/hrpc.peg#L166-L171`
