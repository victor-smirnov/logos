...
> Scope: pattern syntax, binding, refutability, exhaustiveness, and lowering for `match`, `let`, `let ... else`, `for`, and Writ patterns. Source layers: PEG grammar (`tools/peg_gen`), sema (`sema_stmt`/`sema_impl`/`borrow_check`/`sema_render`), and codegen (`mlir_gen_stmt`/`mlir_gen_expr`). Each rule's `id` is its permanent linkable address.
...
**Evidence:** `src/compiler/sema_stmt.cpp#L8270-L8284`
...
**Evidence:** `src/compiler/sema_stmt.cpp#L8762-L8801`
...
**Evidence:** `src/compiler/sema_impl.hpp#L4195-L4200`, `src/compiler/sema_impl.hpp#L4301-L4306`
...
**Evidence:** `src/compiler/sema_stmt.cpp#L8831-L8846`
...
**Evidence:** `src/compiler/sema_stmt.cpp#L8662-L8696`
...
**Evidence:** `src/compiler/sema_stmt.cpp#L8212-L8243`, `src/compiler/sema_stmt.cpp#L8320-L8381`, `src/compiler/sema_stmt.cpp#L8407-L8417`
...
**Evidence:** `src/compiler/sema_stmt.cpp#L8383-L8417`, `src/compiler/sema_stmt.cpp#L8613-L8618`, `src/compiler/sema_stmt.cpp#L8856-L8864`
...
**Evidence:** `src/compiler/sema_stmt.cpp#L8727-L8738`
...
**Evidence:** `src/compiler/sema_stmt.cpp#L8202-L8243`, `src/compiler/sema_stmt.cpp#L8244-L8257`
...
**Evidence:** `src/compiler/sema_stmt.cpp#L8259-L8268`
...
**Evidence:** `src/compiler/sema_stmt.cpp#L8286-L8358`
...
**Evidence:** `src/compiler/sema_stmt.cpp#L8177-L8179`
...
## Parenthesized (grouping) patterns
...
**Evidence:** `src/compiler/borrow_check.cpp#L1477-L1501`
...
**Evidence:** `src/compiler/mlir_gen_stmt.cpp#L19-L49`, `src/compiler/mlir_gen_stmt.cpp#L109-L160`
...
## Variant/aggregate payload binding
...
**Evidence:** `src/compiler/mlir_gen_stmt.cpp#L184-L271`
...
**Evidence:** `src/compiler/mlir_gen_stmt.cpp#L187-L238`
...
**Evidence:** `src/compiler/mlir_gen_stmt.cpp#L116-L142`
...
**Evidence:** `src/compiler/mlir_gen_stmt.cpp#L269-L293`
...
**Evidence:** `src/compiler/mlir_gen_stmt.cpp#L162-L183`
...
**Evidence:** `src/compiler/sema_impl.hpp#L4165-L4170`
...
**Evidence:** `src/compiler/sema_stmt.cpp#L8463-L8507`, `src/compiler/sema_stmt.cpp#L8521-L8531`
...
**Evidence:** `src/compiler/sema_impl.hpp#L2309-L2323`

### `pat.or.single-alt-transparent` — Single-alternative or-pattern is transparent

A PAT_OR node with exactly one alternative (no `|`) is semantically equivalent to that single inner pattern. The grammar wraps every arm/element pattern in a single-alt or-wrapper, which is unwrapped to the inner pattern before matching/destructuring.

**Related:** `pat.or.alt-binding-consistency`

**Evidence:** `src/compiler/sema_stmt.cpp#L4068-L4070`, `src/compiler/sema_stmt.cpp#L8130-L8134`, `src/compiler/sema_stmt.cpp#L8162-L8165`, `src/compiler/sema_stmt.cpp#L8486-L8489`, `src/compiler/sema_stmt.cpp#L8602-L8610`
