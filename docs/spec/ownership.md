...
> **Dual-source** — two extraction artifacts describe this id with differing wording (not a semantic conflict on inspection). The primary statement is above; the alternate phrasing is preserved verbatim below and evidence from both is merged. If the two ever diverge in meaning, treat this as a conflict to resolve before the rule is normative.
>
> *Alternate phrasing:* A generic type parameter T is treated as a move type unless it is bound by T: Copy; absent a Copy bound the parameter is conservatively assumed to own a non-Copy value.
...
For any region r, r: r holds (r outlives itself).

> **Dual-source** — two extraction artifacts describe this id with differing wording (not a semantic conflict on inspection). The primary statement is above; the alternate phrasing is preserved verbatim below and evidence from both is merged. If the two ever diverge in meaning, treat this as a conflict to resolve before the rule is normative.
>
> *Alternate phrasing:* For every lifetime 'a, 'a: 'a holds.
...
**Uncertainty:** Permissive vs strict is a mode flag; default at general sites is permissive.
