...
**Evidence:** `src/compiler/sema_impl.hpp#L2529-L2530`, `src/compiler/sema_impl.hpp#L2720-L2728`
...
## Function-style macros in item position
...
**Evidence:** `src/compiler/sema_expr.cpp#L19281-L19342`
...
**Evidence:** `src/compiler/sema_expr.cpp#L19187-L19201`
...
**Evidence:** `src/compiler/sema_expr.cpp#L19205-L19266`
...
**Evidence:** `src/compiler/sema_expr.cpp#L19176-L19185`
...
**Evidence:** `src/compiler/sema_expr.cpp#L19268-L19273`
...
**Evidence:** `src/compiler/sema_expr.cpp#L19432-L19475`, `src/compiler/sema_expr.cpp#L19609-L19618`
...
**Evidence:** `src/compiler/sema_expr.cpp#L19421-L19430`
...
**Evidence:** `src/compiler/sema_expr.cpp#L19477-L19489`
...
**Evidence:** `src/compiler/sema_expr.cpp#L19491-L19593`
...
**Evidence:** `src/compiler/sema_expr.cpp#L19345-L19371`, `src/compiler/sema_expr.cpp#L19637-L19663`
...
**Evidence:** `src/compiler/sema_expr.cpp#L19372-L19391`, `src/compiler/sema_expr.cpp#L19664-L19682`

## Writ literal capture
...
**Evidence:** `src/compiler/sema.cpp#L7290-L7291`, `src/compiler/sema.cpp#L7395-L7429`, `src/compiler/sema.cpp#L8019-L8020`
...
**Evidence:** `src/compiler/sema.cpp#L7238-L7247`
...
**Evidence:** `src/compiler/sema.cpp#L7159-L7166`
...
**Evidence:** `src/compiler/sema.cpp#L7151-L7217`
...
**Evidence:** `src/compiler/sema.cpp#L7257-L7267`
...
**Evidence:** `src/compiler/sema.cpp#L7235-L7236`
...
**Evidence:** `src/compiler/sema.cpp#L7253-L7278`
...
**Evidence:** `src/compiler/sema.cpp#L7172-L7203`
...
**Evidence:** `src/compiler/sema.cpp#L7337-L7346`
...
**Evidence:** `src/compiler/sema.cpp#L7353-L7361`
...
**Evidence:** `src/compiler/sema.cpp#L7300-L7309`
...
**Evidence:** `src/compiler/sema.cpp#L8000-L8011`
...
**Evidence:** `src/compiler/sema.cpp#L7363-L7369`, `src/compiler/sema.cpp#L7887-L7888`
...
**Evidence:** `src/compiler/sema.cpp#L7310-L7321`
...
## Type intrinsics and reflection
