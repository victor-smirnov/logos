...
private:
    ...
    lir_view::StmtRef lower_let_else_core(lir::LExprPtr scrut, writ::TinyMapView pat_node,
                                          writ::TinyMapView else_node);
    bool pattern_irrefutable(lir_view::PatRef p, TypeRef ty);
