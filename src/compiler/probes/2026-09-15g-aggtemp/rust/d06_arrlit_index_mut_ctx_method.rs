...
use std::ops::*;
// TWIN: generated by l2rs.py from d06_arrlit_index_mut_ctx_method.logos
...
fn g(p: *mut i64) -> i64 {
    let k: i64 = [D { v: 1i64, c: p }, D { v: 10i64, c: p }][1].get() + (W { x: D { v: 100i64, c: p }, y: D { v: 1000i64, c: p }, z: 3i64 }).x.get();
    return k;
}
fn real_main() -> i32 {
    let mut n: i64 = 0i64;
