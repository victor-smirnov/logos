...
use std::ops::*;
// TWIN: generated by l2rs.py from d02_fnptr_field_call_on_temp.logos
...
fn g(p: *mut i64) -> i64 {
    let k: i64 = (Q { f: seven, d: mk(1i64, p) }.f)(p);  // TWIN: a fn-pointer field call needs parens in Rust
    return k;
}
fn real_main() -> i32 {
    let mut n: i64 = 0i64;
