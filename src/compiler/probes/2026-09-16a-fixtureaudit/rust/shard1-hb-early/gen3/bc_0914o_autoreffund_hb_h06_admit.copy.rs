// TWIN of tests/logos/pass/bc_0914o_autoreffund_hb_h06_admit.logos  [A16 --copy variant]
...
// hand battery: round 2026-09-14o-autoreffund, program h06 — caught: (round 2026-09-14n) a direct `lt` operand temporary never dropped on base; 1001 under the landing
...
impl Drop for W { fn drop(&mut self) { unsafe { *self.c = *self.c + self.v; } } }
impl PartialOrd for W {
    fn lt(&self, other: &W) -> bool { return self.v < other.v; }
}
fn body(p: *mut i64) -> i64 {
    let a: W = W { v: 1i64, c: p };
    if !(a < W { v: 1000i64, c: p }) { return 3i64; }
    return 0i64;
}
