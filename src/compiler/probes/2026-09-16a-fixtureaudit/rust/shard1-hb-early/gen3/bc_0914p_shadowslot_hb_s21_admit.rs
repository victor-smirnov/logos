// TWIN of tests/logos/pass/bc_0914p_shadowslot_hb_s21_admit.logos
// envelope translated, BODY VERBATIM
// TWIN: package decl dropped
// TWIN: self: &mut T -> &mut self
// TWIN: fn main()->i32 illegal in Rust; wrapped, exit code preserved
// hand battery: round 0914p_shadowslot, program s21 — caught: verdict moved base -> shadowslot landing
