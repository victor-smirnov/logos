// TWIN of tests/logos/pass/bc_0914o_autoreffund_hb_h10_admit.logos
...
// hand battery: round 2026-09-14o-autoreffund, program h10 — caught: (round 2026-09-14n) an operand temporary in a while condition never dropped on base; 3001 under the landing
...
fn body(p: *mut i64) -> i64 {
    ...
    let mut i: i64 = 0i64;
    while i < 3i64 && (a == D { v: 1000i64, c: p }) { i = i + 1i64; }
    return i - 3i64;
}
