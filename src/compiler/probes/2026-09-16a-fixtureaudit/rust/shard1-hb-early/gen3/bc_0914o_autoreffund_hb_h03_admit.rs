// TWIN of tests/logos/pass/bc_0914o_autoreffund_hb_h03_admit.logos
...
// hand battery: round 2026-09-14o-autoreffund, program h03 — caught: (round 2026-09-14n) temporaries on both sides of `==` never dropped on base (n=1); 1101 under the landing
...
fn body(p: *mut i64) -> i64 {
    ...
    if !(D { v: 100i64, c: p } == D { v: 1000i64, c: p }) { return 3i64; }
    return a.v - 1i64;
}
