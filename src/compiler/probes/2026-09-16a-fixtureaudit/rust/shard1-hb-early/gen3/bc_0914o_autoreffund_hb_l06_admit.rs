// TWIN of tests/logos/pass/bc_0914o_autoreffund_hb_l06_admit.logos
...
// hand battery: round 2026-09-14o-autoreffund, program l06 — caught: `side(s) + *mkg(s).peek()`: a generic receiver temporary built first on base (216); 126 under the landing
...
fn __logos_main() -> i32 {
    let mut q: i64 = 0i64;
    let s: *mut i64 = &mut q;
    let k: i64 = side(s) + *mkg(s).peek();
    let got: i64 = rd(s);
    unsafe { print!("k={} seq={}\n", k, got); }
    if k != 6i64 { return 2i32; }
