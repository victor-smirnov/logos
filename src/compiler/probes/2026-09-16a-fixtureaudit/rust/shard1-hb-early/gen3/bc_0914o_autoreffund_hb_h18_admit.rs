// TWIN of tests/logos/pass/bc_0914o_autoreffund_hb_h18_admit.logos
...
// hand battery: round 2026-09-14o-autoreffund, program h18 — caught: (round 2026-09-14n) an operand temporary in an if condition whose then-branch returns never dropped on base; 1001 under the landing
...
fn inner(p: *mut i64) -> i64 {
    let a: D = D { v: 1i64, c: p };
    if (a == D { v: 1000i64, c: p }) { return 5i64; }
    return 6i64;
}
