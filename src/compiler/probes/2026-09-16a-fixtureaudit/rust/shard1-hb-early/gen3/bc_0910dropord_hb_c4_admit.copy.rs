// TWIN of tests/logos/pass/bc_0910dropord_hb_c4_admit.logos  [A16 --copy variant]
...
// hand battery: round 2026-09-10dropord, program c4 — caught: verdict moved base -> landed — PROBES.md "c1 struct, 3 fields 321 -> 123 ... c17 nested struct + user Drop 3n921 -> n9123" (drop order, landed 1fad68657)
...
struct U { a: O, b: O }
impl Drop for U { fn drop(&mut self) { p("u%d", 9); } }
fn __logos_main() -> i32 {
    {
