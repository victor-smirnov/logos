// TWIN of tests/logos/pass/bc_0914o_autoreffund_hb_r02_admit.logos
...
// hand battery: round 2026-09-14o-autoreffund, program r02 — caught: `side(s) + mk(2, s).get()`: the receiver temporary was built before the left operand on base (216); 126 under the landing
...
fn __logos_main() -> i32 {
    let mut q: i64 = 0i64;
    let s: *mut i64 = &mut q;
    let k: i64 = side(s) + mk(2i64, s).get();
