// TWIN of tests/logos/pass/bc_0914o_autoreffund_hb_h13_admit.logos
...
// hand battery: round 2026-09-14o-autoreffund, program h13 — caught: (round 2026-09-14n) a temporary operand beside a deref place operand never dropped on base; 1001 under the landing
...
fn body(p: *mut i64) -> i64 {
    ...
    let r: &D = &a;
    if !(*r == D { v: 1000i64, c: p }) { return 3i64; }
    return 0i64;
}
