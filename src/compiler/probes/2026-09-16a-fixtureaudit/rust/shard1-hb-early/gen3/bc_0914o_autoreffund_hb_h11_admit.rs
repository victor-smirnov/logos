// TWIN of tests/logos/pass/bc_0914o_autoreffund_hb_h11_admit.logos
...
// hand battery: round 2026-09-14o-autoreffund, program h11 — caught: (round 2026-09-14n) an operand temporary in a `return` expression never dropped on base; 1001 under the landing
...
fn cmpret(p: *mut i64) -> bool {
    let a: D = D { v: 1i64, c: p };
    return a == D { v: 1000i64, c: p };
}
fn body(p: *mut i64) -> i64 {
    if !cmpret(p) { return 3i64; }
    return 0i64;
}
