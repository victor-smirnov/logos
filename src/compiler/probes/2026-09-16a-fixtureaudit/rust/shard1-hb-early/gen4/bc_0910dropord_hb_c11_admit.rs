...
// hand battery: round 2026-09-10dropord, program c11 — caught: verdict moved base -> landed — PROBES.md "c1 struct, 3 fields 321 -> 123 ... c17 nested struct + user Drop 3n921 -> n9123\0" (drop order, landed 1fad68657)
