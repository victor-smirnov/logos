// TWIN of tests/logos/pass/bc_0914o_autoreffund_hb_c22_admit.logos
...
// hand battery: round 2026-09-14o-autoreffund, program c22 — caught: `return *pick(a, s) == mk(..)`: the return-bind path leaked the temporary on base (12); 126 under the landing
...
fn body(a: &D, s: *mut i64) -> bool {
    return *pick(a, s) == mk(2i64, s);
}
fn __logos_main() -> i32 {
    let mut q: i64 = 0i64;
    let s: *mut i64 = &mut q;
