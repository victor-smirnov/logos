// TWIN of tests/logos/pass/bc_0914o_autoreffund_hb_h24_admit.logos
...
// hand battery: round 2026-09-14o-autoreffund, program h24 — caught: (round 2026-09-14n) operand temporaries inside a closure body never dropped on base (n=0); 2020 under the landing
...
fn body(p: *mut i64) -> i64 {
    let f = || -> bool { return D { v: 1000i64, c: p } == D { v: 10i64, c: p }; };
    let x: bool = f();
    let y: bool = f();
    if !(x && y) { return 3i64; }
    return 0i64;
