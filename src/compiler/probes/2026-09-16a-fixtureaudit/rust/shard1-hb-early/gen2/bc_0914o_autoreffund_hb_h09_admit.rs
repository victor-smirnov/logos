// TWIN of tests/logos/pass/bc_0914o_autoreffund_hb_h09_admit.logos
...
// hand battery: round 2026-09-14o-autoreffund, program h09 — caught: (round 2026-09-14n) an operand temporary in the taken RHS of `&&` never dropped on base; 1001 under the landing
...
fn body(p: *mut i64) -> i64 {
    ...
    let f: bool = a.v > 0i64;
    if f && (a == D { v: 1000i64, c: p }) { return 0i64; }
    return 3i64;
}
