// TWIN of tests/logos/pass/bc_0914o_autoreffund_hb_h02_admit.logos
...
// hand battery: round 2026-09-14o-autoreffund, program h02 — caught: (program of round 2026-09-14n-autoreftemp) a temporary LEFT operand of `==` never dropped on base (n=1); 1001 under the landing
...
fn body(p: *mut i64) -> i64 {
    ...
    if !(D { v: 1000i64, c: p } == a) { return 3i64; }
    return 0i64;
}
