// TWIN of tests/logos/pass/bc_0914p_shadowslot_hb_s09_admit.logos
// envelope translated, BODY VERBATIM
// TWIN: package decl dropped
// TWIN: `use logos.mem.string;` dropped (prelude in Rust)
// TWIN: self: &mut T -> &mut self
// TWIN: fn main()->i32 illegal in Rust; wrapped, exit code preserved
// hand battery: round 0914p_shadowslot, program s09 — caught: verdict moved base -> shadowslot landing
...
fn __logos_main() -> i32 {
    ...
    let p: *mut i64 = &mut n;
    {
        let x: String = String::from("abcdefghijklmnopqrstuvwxyz");
