// TWIN of tests/logos/pass/bc_0914o_autoreffund_hb_h17_admit.logos
...
// hand battery: round 2026-09-14o-autoreffund, program h17 — caught: (round 2026-09-14n) an operand temporary in a match guard never dropped on base; 1001 under the landing
...
fn body(p: *mut i64) -> i64 {
    ...
    let mut r: i64 = 3i64;
    match k {
        1i64 if a == D { v: 1000i64, c: p } => { r = 0i64; },
        _ => { r = 4i64; }
    }
    return r;
}
