// TWIN of tests/logos/pass/bc_0914o_autoreffund_hb_h04_admit.logos
...
// hand battery: round 2026-09-14o-autoreffund, program h04 — caught: (round 2026-09-14n) a `!=` operand temporary in a `let` initialiser never dropped on base; 1001 under the landing
