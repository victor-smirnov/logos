// RUST TWIN of x08_op_loop_move.logos (mechanical, tools: l2rs.py of round 2026-09-15e-consume)
...
fn g(p: *mut i64) -> i64 { let a: D = D { v: 1i64, c: p }; let mut i: i64 = 0i64; while i < 2i64 { let b: D = D { v: 10i64, c: p }; let s: D = a + b; i = i + 1i64 + s.v * 0i64; } return i; }
fn logos_main() -> i32 {
    let mut n: i64 = 0i64;
    let p: *mut i64 = &mut n;
    let r: i64 = g(p);
