// RUST TWIN of o07_add_params.logos (mechanical, tools: l2rs.py of round 2026-09-15e-consume)
...
fn h(a: D, b: D) -> i64 { return a + b; }
fn g(p: *mut i64) -> i64 { return h(D { v: 1i64, c: p }, D { v: 10i64, c: p }); }
fn logos_main() -> i32 {
    let mut n: i64 = 0i64;
    let p: *mut i64 = &mut n;
    let r: i64 = g(p);
