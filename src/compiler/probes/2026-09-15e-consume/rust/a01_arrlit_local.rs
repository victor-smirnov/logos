// RUST TWIN of a01_arrlit_local.logos (mechanical, tools: l2rs.py of round 2026-09-15e-consume)
...
fn g(p: *mut i64) -> i64 {
    { let a: D = D { v: 1i64, c: p }; let b: D = D { v: 10i64, c: p }; let arr: [D; 2] = [a, b]; if arr[0].v != 1i64 { return 7i64; } }
    return 0i64;
}
fn logos_main() -> i32 {
    let mut n: i64 = 0i64;
