// RUST TWIN of b15_heap_arrlit.logos (mechanical, tools: l2rs.py of round 2026-09-15e-consume)
...
// TWIN: .len() sum cast `as i64` (usize)
...
fn g(p: *mut i64) -> i64 { let a: String = String::from("hello"); let b: String = String::from("world"); let arr: [String; 2] = [a, b]; return (arr[0].len() + arr[1].len()) as i64; }
fn logos_main() -> i32 {
    let mut n: i64 = 0i64;
    let p: *mut i64 = &mut n;
    let r: i64 = g(p);
