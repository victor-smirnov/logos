// RUST TWIN of d06_closure_call_arg.logos (mechanical, tools: l2rs.py of round 2026-09-15e-consume)
...
fn g(p: *mut i64) -> i64 { let f = |d: D| -> i64 { return d.v * 0i64; }; let a: D = D { v: 1i64, c: p }; return f(a); }
fn logos_main() -> i32 {
    let mut n: i64 = 0i64;
    let p: *mut i64 = &mut n;
    let r: i64 = g(p);
