// RUST TWIN of e14_generic_struct_arrlit.logos (mechanical, tools: l2rs.py of round 2026-09-15e-consume)
...
struct G<T> { a: T, b: T }
impl<T> G<T> { fn arr(self) -> [T; 2] { return [self.a, self.b]; } }
fn g(p: *mut i64) -> i64 { let x: G<D> = G { a: D { v: 1i64, c: p }, b: D { v: 10i64, c: p } }; { let arr: [D; 2] = x.arr(); if arr[1].v != 10i64 { return 7i64; } } return 0i64; }
fn logos_main() -> i32 {
    let mut n: i64 = 0i64;
    let p: *mut i64 = &mut n;
    let r: i64 = g(p);
