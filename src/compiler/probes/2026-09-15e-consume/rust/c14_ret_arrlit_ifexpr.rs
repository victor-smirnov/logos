// RUST TWIN of c14_ret_arrlit_ifexpr.logos (mechanical, tools: l2rs.py of round 2026-09-15e-consume)
...
fn mk(p: *mut i64, k: bool) -> [D; 1] { let a: D = D { v: 1i64, c: p }; let b: D = D { v: 10i64, c: p }; return if k { [a] } else { [b] }; }
fn g(p: *mut i64) -> i64 { { let arr: [D; 1] = mk(p, true); if arr[0].v != 1i64 { return 7i64; } } return 0i64; }
fn logos_main() -> i32 {
    let mut n: i64 = 0i64;
    let p: *mut i64 = &mut n;
    let r: i64 = g(p);
