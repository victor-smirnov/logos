// RUST TWIN of b11_op_loop_fresh.logos (mechanical, tools: l2rs.py of round 2026-09-15e-consume)
...
fn g(p: *mut i64) -> i64 { let mut i: i64 = 0i64; while i < 3i64 { let a: D = D { v: 1i64, c: p }; let b: D = D { v: 10i64, c: p }; let s: D = a + b; i = i + 1i64 + s.v * 0i64; } return i; }
fn logos_main() -> i32 {
    let mut n: i64 = 0i64;
    let p: *mut i64 = &mut n;
    let r: i64 = g(p);
    let got: i64 = rd(p);
    if got != 333i64 { return 1i32; }
    return 0i32;
}
