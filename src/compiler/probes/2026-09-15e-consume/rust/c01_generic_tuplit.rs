// RUST TWIN of c01_generic_tuplit.logos (mechanical, tools: l2rs.py of round 2026-09-15e-consume)
...
fn two<T>(x: T, y: T) -> (T, T) { return (x, y); }
fn g(p: *mut i64) -> i64 { { let t: (D, D) = two(D { v: 1i64, c: p }, D { v: 10i64, c: p }); if t.1.v != 10i64 { return 7i64; } } return 0i64; }
fn logos_main() -> i32 {
    let mut n: i64 = 0i64;
    let p: *mut i64 = &mut n;
    let r: i64 = g(p);
