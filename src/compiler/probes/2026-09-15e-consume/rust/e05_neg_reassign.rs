// RUST TWIN of e05_neg_reassign.logos (mechanical, tools: l2rs.py of round 2026-09-15e-consume)
...
fn g(p: *mut i64) -> i64 { let mut x: D = D { v: 1i64, c: p }; x = -x; return x.v; }
fn logos_main() -> i32 {
    let mut n: i64 = 0i64;
    let p: *mut i64 = &mut n;
    let r: i64 = g(p);
    let got: i64 = rd(p);
    if got != 101i64 { return 1i32; }
    return 0i32;
}
