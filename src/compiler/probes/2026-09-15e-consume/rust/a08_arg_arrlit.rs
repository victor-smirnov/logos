// RUST TWIN of a08_arg_arrlit.logos (mechanical, tools: l2rs.py of round 2026-09-15e-consume)
...
fn eat(x: [D; 2]) -> i64 { return x[0].v; }
fn g(p: *mut i64) -> i64 { let a: D = D { v: 1i64, c: p }; let b: D = D { v: 10i64, c: p }; return eat([a, b]); }
fn logos_main() -> i32 {
    let mut n: i64 = 0i64;
    let p: *mut i64 = &mut n;
    let r: i64 = g(p);
