// RUST TWIN of c12_op_call_lhs.logos (mechanical, tools: l2rs.py of round 2026-09-15e-consume)
...
fn mk(p: *mut i64) -> D { return D { v: 1i64, c: p }; }
fn g(p: *mut i64) -> i64 { let b: D = D { v: 10i64, c: p }; let s: D = mk(p) + b; return s.v; }
fn logos_main() -> i32 {
    let mut n: i64 = 0i64;
    let p: *mut i64 = &mut n;
    let r: i64 = g(p);
