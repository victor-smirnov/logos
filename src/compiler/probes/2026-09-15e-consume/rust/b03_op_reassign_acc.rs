// RUST TWIN of b03_op_reassign_acc.logos (mechanical, tools: l2rs.py of round 2026-09-15e-consume)
...
fn g(p: *mut i64) -> i64 { let mut acc: D = D { v: 1i64, c: p }; let d: D = D { v: 10i64, c: p }; acc = acc + d; return acc.v; }
fn logos_main() -> i32 {
    let mut n: i64 = 0i64;
    let p: *mut i64 = &mut n;
    let r: i64 = g(p);
