// RUST TWIN of e04_self_fields_byvalue.logos (mechanical, tools: l2rs.py of round 2026-09-15e-consume)
...
impl W { fn both(self) -> [D; 2] { return [self.x, self.y]; } }
fn g(p: *mut i64) -> i64 { let w: W = W { x: D { v: 1i64, c: p }, y: D { v: 10i64, c: p } }; { let arr: [D; 2] = w.both(); if arr[1].v != 10i64 { return 7i64; } } return 0i64; }
fn logos_main() -> i32 {
    let mut n: i64 = 0i64;
    let p: *mut i64 = &mut n;
    let r: i64 = g(p);
