// RUST TWIN of e03_arrlit_loop_reinit.logos (mechanical, tools: l2rs.py of round 2026-09-15e-consume)
...
fn g(p: *mut i64) -> i64 { let mut a: D = D { v: 1i64, c: p }; let mut i: i64 = 0i64; while i < 3i64 { let arr: [D; 1] = [a]; i = i + arr[0].v; a = D { v: 1i64, c: p }; } return i; }
fn logos_main() -> i32 {
    let mut n: i64 = 0i64;
    let p: *mut i64 = &mut n;
    let r: i64 = g(p);
    let got: i64 = rd(p);
    if got != 4i64 { return 1i32; }
    return 0i32;
}
