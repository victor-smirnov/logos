// RUST TWIN of f01_tv_copy_dup.logos (mechanical, tools: l2rs.py of round 2026-09-15e-consume)
...
fn dup<T: Copy>(x: T) -> [T; 2] { return [x, x]; }
fn g(p: *mut i64) -> i64 { let a: [P; 2] = dup(P { v: 3i64 }); return a[0].v + a[1].v; }
fn logos_main() -> i32 {
    let mut n: i64 = 0i64;
    let p: *mut i64 = &mut n;
    let r: i64 = g(p);
