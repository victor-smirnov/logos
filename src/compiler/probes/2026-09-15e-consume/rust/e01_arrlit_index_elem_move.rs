// RUST TWIN of e01_arrlit_index_elem_move.logos (mechanical, tools: l2rs.py of round 2026-09-15e-consume)
...
fn g(p: *mut i64) -> i64 { let src: [D; 1] = [D { v: 1i64, c: p }]; let arr: [D; 1] = [src[0]]; return arr[0].v; }
fn logos_main() -> i32 {
    let mut n: i64 = 0i64;
    let p: *mut i64 = &mut n;
    let r: i64 = g(p);
