// RUST TWIN of m02_at_return.logos (mechanical, tools: l2rs.py of round 2026-09-15e-consume)
...
fn g(p: *mut i64) -> i64 { let x: D = D { v: 1i64, c: p }; let o: Option<D> = Option::Some(D { v: 2i64, c: p });
    match o { y @ Option::Some(_) => { if y.is_some() { return 4i64; } return 3i64; } Option::None => {} }
    return x.v; }
fn logos_main() -> i32 {
    let mut n: i64 = 0i64;
    let p: *mut i64 = &mut n;
