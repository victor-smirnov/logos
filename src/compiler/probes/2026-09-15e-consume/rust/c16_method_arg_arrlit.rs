// RUST TWIN of c16_method_arg_arrlit.logos (mechanical, tools: l2rs.py of round 2026-09-15e-consume)
...
struct K { k: i64 }
impl K { fn take(&self, a: [D; 2]) -> i64 { return a[1].v * 0i64 + self.k; } }
fn g(p: *mut i64) -> i64 { let a: D = D { v: 1i64, c: p }; let b: D = D { v: 10i64, c: p }; let k: K = K { k: 0i64 }; return k.take([a, b]); }
fn logos_main() -> i32 {
    let mut n: i64 = 0i64;
    let p: *mut i64 = &mut n;
    let r: i64 = g(p);
