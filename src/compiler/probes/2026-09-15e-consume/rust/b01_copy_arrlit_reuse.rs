// RUST TWIN of b01_copy_arrlit_reuse.logos (mechanical, tools: l2rs.py of round 2026-09-15e-consume)
...
fn g(p: *mut i64) -> i64 { let a: P = P { v: 1i64 }; let arr: [P; 2] = [a, a]; return arr[0].v + a.v; }
fn logos_main() -> i32 {
    let mut n: i64 = 0i64;
    let p: *mut i64 = &mut n;
    let r: i64 = g(p);
