// RUST TWIN of b17_arrlit_of_arrlit_var.logos (mechanical, tools: l2rs.py of round 2026-09-15e-consume)
...
fn g(p: *mut i64) -> i64 { let a: D = D { v: 1i64, c: p }; let inner: [D; 1] = [a]; { let outer: [[D; 1]; 1] = [inner]; if outer[0][0].v != 1i64 { return 7i64; } } return 0i64; }
fn logos_main() -> i32 {
    let mut n: i64 = 0i64;
    let p: *mut i64 = &mut n;
    let r: i64 = g(p);
