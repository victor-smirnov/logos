// RUST TWIN of e08_arrlit_option_locals.logos (mechanical, tools: l2rs.py of round 2026-09-15e-consume)
...
fn g(p: *mut i64) -> i64 { let a: Option<D> = Option::Some(D { v: 1i64, c: p }); let b: Option<D> = Option::None; { let arr: [Option<D>; 2] = [a, b]; if arr[1].is_some() { return 7i64; } } return 0i64; }
fn logos_main() -> i32 {
    let mut n: i64 = 0i64;
    let p: *mut i64 = &mut n;
    let r: i64 = g(p);
