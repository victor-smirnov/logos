// RUST TWIN of m07_tuple_return.logos (mechanical, tools: l2rs.py of round 2026-09-15e-consume)
...
fn g(p: *mut i64) -> i64 { let a: D = D { v: 1i64, c: p }; let t: (D, D) = (D { v: 2i64, c: p }, D { v: 3i64, c: p });
    match t { (z, b) => { return z.v + b.v; } } }
fn logos_main() -> i32 {
    let mut n: i64 = 0i64;
    let p: *mut i64 = &mut n;
    let r: i64 = g(p);
