// RUST TWIN of b04_arrlit_reassign_src.logos (mechanical, tools: l2rs.py of round 2026-09-15e-consume)
...
fn g(p: *mut i64) -> i64 { let mut a: D = D { v: 1i64, c: p }; { let arr: [D; 1] = [a]; if arr[0].v != 1i64 { return 7i64; } } a = D { v: 10i64, c: p }; return a.v; }
fn logos_main() -> i32 {
    let mut n: i64 = 0i64;
    let p: *mut i64 = &mut n;
    let r: i64 = g(p);
