// RUST TWIN of d04_dyn_method_arg.logos (mechanical, tools: l2rs.py of round 2026-09-15e-consume)
...
fn g(p: *mut i64) -> i64 { let k: K = K { k: 0i64 }; let t: &dyn Tk = &k; let a: D = D { v: 1i64, c: p }; return t.take(a); }
fn logos_main() -> i32 {
    let mut n: i64 = 0i64;
    let p: *mut i64 = &mut n;
    let r: i64 = g(p);
