// RUST TWIN of d12_add_tuple_elem.logos (mechanical, tools: l2rs.py of round 2026-09-15e-consume)
...
fn g(p: *mut i64) -> i64 { let t: (D, D) = (D { v: 1i64, c: p }, D { v: 10i64, c: p }); let s: D = t.0 + t.1; return s.v; }
fn logos_main() -> i32 {
    let mut n: i64 = 0i64;
    let p: *mut i64 = &mut n;
    let r: i64 = g(p);
