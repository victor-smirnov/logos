// RUST TWIN of m09_tstruct_return.logos (mechanical, tools: l2rs.py of round 2026-09-15e-consume)
...
fn g(p: *mut i64) -> i64 { let a: D = D { v: 1i64, c: p }; let t: T = T(D { v: 2i64, c: p }, 3i64);
    match t { T(z, k) => { return z.v + k; } } }
fn logos_main() -> i32 {
    let mut n: i64 = 0i64;
    let p: *mut i64 = &mut n;
    let r: i64 = g(p);
