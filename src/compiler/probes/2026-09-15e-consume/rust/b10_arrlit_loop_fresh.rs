// RUST TWIN of b10_arrlit_loop_fresh.logos (mechanical, tools: l2rs.py of round 2026-09-15e-consume)
...
fn g(p: *mut i64) -> i64 { let mut i: i64 = 0i64; while i < 3i64 { let a: D = D { v: 1i64, c: p }; let arr: [D; 1] = [a]; i = i + arr[0].v; } return i; }
fn logos_main() -> i32 {
    let mut n: i64 = 0i64;
    let p: *mut i64 = &mut n;
    let r: i64 = g(p);
