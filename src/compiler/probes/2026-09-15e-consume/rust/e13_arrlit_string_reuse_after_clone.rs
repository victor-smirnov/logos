// RUST TWIN of e13_arrlit_string_reuse_after_clone.logos (mechanical, tools: l2rs.py of round 2026-09-15e-consume)
...
fn g(p: *mut i64) -> i64 { let s: String = String::from("ab"); let arr: [String; 2] = [s.clone(), s]; return (arr[0].len() + arr[1].len()) as i64; }
fn logos_main() -> i32 {
    let mut n: i64 = 0i64;
    let p: *mut i64 = &mut n;
    let r: i64 = g(p);
