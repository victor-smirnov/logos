// RUST TWIN of e02_arrlit_mutref_elems.logos (mechanical, tools: l2rs.py of round 2026-09-15e-consume)
...
fn g(p: *mut i64) -> i64 { let mut a: D = D { v: 1i64, c: p }; let mut b: D = D { v: 10i64, c: p }; { let arr: [&mut D; 2] = [&mut a, &mut b]; arr[0].v = 2i64; } return a.v + b.v; }
fn logos_main() -> i32 {
    let mut n: i64 = 0i64;
    let p: *mut i64 = &mut n;
    let r: i64 = g(p);
