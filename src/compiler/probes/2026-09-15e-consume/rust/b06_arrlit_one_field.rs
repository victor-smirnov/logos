// RUST TWIN of b06_arrlit_one_field.logos (mechanical, tools: l2rs.py of round 2026-09-15e-consume)
...
fn g(p: *mut i64) -> i64 { let w: W = W { x: D { v: 1i64, c: p }, y: D { v: 10i64, c: p } }; { let arr: [D; 1] = [w.x]; if arr[0].v != 1i64 { return 7i64; } } return w.y.v; }
fn logos_main() -> i32 {
    let mut n: i64 = 0i64;
    let p: *mut i64 = &mut n;
    let r: i64 = g(p);
