// RUST TWIN of m03_at_struct_noreturn.logos (mechanical, tools: l2rs.py of round 2026-09-15e-consume)
...
fn g(p: *mut i64) -> i64 { let x: D = D { v: 1i64, c: p }; let w: D = D { v: 2i64, c: p };
    let mut k: i64 = 0i64;
    match w { y @ D { v: _, c: _ } => { k = y.v; } }
    return k + x.v; }
fn logos_main() -> i32 {
    let mut n: i64 = 0i64;
    let p: *mut i64 = &mut n;
