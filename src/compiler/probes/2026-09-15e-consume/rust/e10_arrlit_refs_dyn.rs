// RUST TWIN of e10_arrlit_refs_dyn.logos (mechanical, tools: l2rs.py of round 2026-09-15e-consume)
...
fn g(p: *mut i64) -> i64 { let a: D = D { v: 1i64, c: p }; let b: D = D { v: 10i64, c: p }; let s: i64 = { let arr: [&dyn Tr; 2] = [&a, &b]; arr[0].get() + arr[1].get() }; return s + a.v; }
fn logos_main() -> i32 {
    let mut n: i64 = 0i64;
    let p: *mut i64 = &mut n;
    let r: i64 = g(p);
