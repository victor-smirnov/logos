...
namespace logos_ast {
    ...
    inline constexpr Code FIELD_COMPOUND_ASSIGN {"FIELD_COMPOUND_ASSIGN", 136};
    inline constexpr Code INDEX_COMPOUND_ASSIGN {"INDEX_COMPOUND_ASSIGN", 137};
...
private:
    ...
    logos::hermes::AnyVal rule_ref_pointee();
    ...
    logos::hermes::AnyVal rule_loop_expr();
    ...
    logos::hermes::AnyVal rule_field_compound_assign_stmt();
    logos::hermes::AnyVal rule_index_compound_assign_stmt();
    ...
    logos::hermes::AnyVal rule_generic_struct_lit();
    ...
    bool  try_token_gt(); // GT_TYPE pseudo-token: also splits SHR (>>) into two GTs
