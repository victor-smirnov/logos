...
static void test_tiny_map_update() {
    ...
    LOGOS_ASSERT(map->get(3).as_value<int32_t>() == 10, "INV-TINYMAP-001", "");
    ...
    LOGOS_ASSERT(map->get(3).as_value<int32_t>() == 20, "INV-TINYMAP-001",
...
static void test_tiny_map_remove() {
    ...
    LOGOS_ASSERT(map->get(0).as_value<int32_t>() == 1, "INV-TINYMAP-001", "");
    LOGOS_ASSERT(map->get(2).as_value<int32_t>() == 3, "INV-TINYMAP-001", "");

    // Remove non-existent.
    LOGOS_ASSERT(!map->remove(1), "INV-TINYMAP-001",
...
static void test_object_array_basic() {
    ...
    LOGOS_ASSERT(arr->get(0).as_value<int32_t>() == 10, "HERMES-ARRAY-001", "");
    LOGOS_ASSERT(arr->get(1).as_value<int32_t>() == 20, "HERMES-ARRAY-001", "");
    LOGOS_ASSERT(arr->get(2).as_value<float>() == 3.14f, "HERMES-ARRAY-001", "");

    // Out of bounds returns null.
    LOGOS_ASSERT(arr->get(100).is_null(), "HERMES-ARRAY-001", "");
...
static void test_object_array_grow() {
    ...
    // Verify all values.
    for (int i = 0; i < 100; ++i) {
        LOGOS_ASSERT(arr->get(i).as_value<int32_t>() == i, "HERMES-ARRAY-001",
            "Array[{}] must be {}", i, i);
    }
...
static void test_object_array_set_and_pop() {
    ...
    // Set.
    arr->set(1, TaggedPtr::from_value(int32_t(99), type_hash::Integer));
    LOGOS_ASSERT(arr->get(1).as_value<int32_t>() == 99, "HERMES-ARRAY-001", "");

    // Pop.
    arr->pop_back();
    LOGOS_ASSERT(arr->size() == 2, "HERMES-ARRAY-001", "Size after pop must be 2");
    LOGOS_ASSERT(arr->get(0).as_value<int32_t>() == 1, "HERMES-ARRAY-001", "");
    LOGOS_ASSERT(arr->get(1).as_value<int32_t>() == 99, "HERMES-ARRAY-001", "");
...
static void test_object_map_basic() {
    ...
    LOGOS_ASSERT(map->has("name"), "HERMES-MAP-001", "");
    LOGOS_ASSERT(map->has("age"), "HERMES-MAP-001", "");
    LOGOS_ASSERT(!map->has("missing"), "HERMES-MAP-001", "");

    LOGOS_ASSERT(map->get("name").as_value<int32_t>() == 42, "HERMES-MAP-001", "");
    LOGOS_ASSERT(map->get("age").as_value<int32_t>() == 30, "HERMES-MAP-001", "");
    LOGOS_ASSERT(map->get("missing").is_null(), "HERMES-MAP-001", "");
...
static void test_object_map_update() {
    ...
    LOGOS_ASSERT(map->get("key").as_value<int32_t>() == 2, "HERMES-MAP-001", "");
...
static void test_object_map_remove() {
    ...
    LOGOS_ASSERT(!map->has("b"), "HERMES-MAP-001", "");
    LOGOS_ASSERT(map->has("a"), "HERMES-MAP-001", "");
    LOGOS_ASSERT(map->has("c"), "HERMES-MAP-001", "");
