...
//
// ExternalRef resolution (Hermes2). See external_ref.hpp. Walks the pool dispatch
...
#include <logos/hermes2/document.hpp>        // doc_header
#include <logos/hermes2/lir_arena_root.hpp>  // SCHEMA_CODE, DIRECTORY
