...
template <>
struct std::hash<logos::hermes2::arena_offset_t> {
    size_t operator()(logos::hermes2::arena_offset_t o) const noexcept {
...
template <>
struct std::formatter<logos::hermes2::arena_offset_t> : std::formatter<uint32_t> {
    auto format(logos::hermes2::arena_offset_t o, auto& ctx) const {
