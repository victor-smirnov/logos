...
// TOM field present in BOTH this C++ form AND the Logos stdlib HMap<Hu6,HVal> (the
...
public:
    ...
    // ImportTable, metaprog ExprBlob roots); byte-shared with Logos HMap<Hu6,HVal>.
...
private:
    // Layout matches Logos HMap<Hu6,HVal> byte-for-byte. The `#[zoned2]` pointer
...
// header_(8) + data_(8, self-relative i64) + schema_type_code_(8) = 24 (matches HMap<Hu6,HVal>)
