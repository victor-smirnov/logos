...
// BYTE-IDENTICAL to the Logos stdlib WMap<Wu6, WAny> (stdlib/lang/writ/wmap.logos
// "bitmap-indexed spec"):
//
...
// TOM field present in BOTH this C++ form AND the Logos stdlib WMap<Wu6,WAny> (the
...
public:
    ...
    // ImportTable, metaprog ExprBlob roots); byte-shared with Logos WMap<Wu6,WAny>.
...
private:
    // Layout matches Logos WMap<Wu6,WAny> byte-for-byte. The `#[zoned2]` pointer
...
// header_(8) + data_(8, self-relative i64) + schema_type_code_(8) = 24 (matches WMap<Wu6,WAny>)
