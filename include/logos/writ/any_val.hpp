...
#include <cstdint>
#include <type_traits>
#include <logos/writ/config.hpp>     // arena_offset_t (for the mirror's base+offset handles)
#include <logos/writ/type_codes.hpp> // tc::* (Pod code deduction for from_value<T>)
