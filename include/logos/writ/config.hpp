...
// ---------------------------------------------------------------------------
// Writ scalar error codes (range 0x0001'0000 … 0x0001'FFFF).
// ---------------------------------------------------------------------------
...
template <>
struct std::hash<logos::writ::arena_offset_t> {
    size_t operator()(logos::writ::arena_offset_t o) const noexcept {
...
template <>
struct std::formatter<logos::writ::arena_offset_t> : std::formatter<uint32_t> {
    auto format(logos::writ::arena_offset_t o, auto& ctx) const {
