...
PIN = {
    ...
    # RECEIVER conformance landing): `ls tests/logos/pass/*.logos | wc -l` -> 2994,
    # `ls tests/logos/pass/{wql_*,deem_*}.logos | wc -l` -> 191, 2994 = 191 + 2803
