...
PIN = {
    ...
    # listing): `ls tests/logos/pass/*.logos | wc -l` -> 2999,
    # `ls tests/logos/pass/{wql_*,deem_*}.logos | wc -l` -> 191, 2999 = 191 + 2808
