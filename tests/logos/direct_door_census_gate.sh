...
# units only.
PIN = {
    # ⚠ RE-DERIVED at the 2026-09-09c parameter-door binder-walk stage, BY
    # DIRECT FILE LISTING and never by adding to the previous line:
    #   ls tests/logos/pass/*.logos | wc -l              -> 2975
    #   ls tests/logos/pass/{wql_*,deem_*}.logos | wc -l ->  191
    # partition closes: 2975 = 191 + 2784. Six pass fixtures joined `nonglob`
    # (none matches the glob); the round's seven FAIL halves are not in this
    # population. DOOR counts unmoved — none of the six declares a container
