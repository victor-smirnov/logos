...
|---|------|--------------|--------|
| 1.1 | Never/divergence | `tests/logos/pass/core_1_1_never_fallback.logos` | to add (🟡) |
| 1.2 | Coercion canonical order | verified-by-suite (pure refactor) | ✅ |
| 1.3 | `Kind::InferredType` | `tests/logos/pass/core_1_3_inferred_nested.logos` | to add (🟡) |
...
| 2.8 | Object-safety | `tests/logos/fail/core_2_8_obj_safety_generic_method.logos` | partial (🟡) |
